                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $catatan)){
                                ...
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $sifat)){
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_disposisi(tujuan,isi_disposisi,sifat,batas_waktu,catatan,statusd,pengirim,id_surat,id_user)
                                        VALUES('$tujuan','$isi_disposisi','$sifat','$batas_waktu','$catatan','$statusd','$pengirim','$id_surat','$id_user')");
                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s7">
                            <i class="material-icons prefix md-prefix">featured_play_list   </i>
                            <input id="statusd" type="text" class="validate" name="statusd" value="Belum Terlaksana" readonly required>
                                <?php
                        ...
                        <div class="input-field col s6">
                           <i class="material-icons prefix md-prefix">low_priority</i><label>Pilih Pengirim</label><br/>
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="pengirim" id="pengirim" required>
