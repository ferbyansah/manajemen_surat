        ...
        if(isset($_REQUEST['sub'])){
            ...
            $pg = @$_GET['pg'];
                ...
                if(mysqli_num_rows($query) > 0){
                    ...
                    if($_SESSION['admin'] = 3 AND $_SESSION['admin'] != 3){
                                                ...
                                                <div class="col m12">
                                                    <ul class="left">
                                                        ...
                                                        <li class="waves-effect waves-light">
                                                            <a href="?page=tsmd&act=disp&id_surat='.$row['id_surat'].'&sub=add"><i class="material-icons md-24">add_circle</i> Tambah Disposisi</a>
                                                        </li>
                                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsmd"><i class="material-icons">arrow_back</i> Kembali</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </nav>
                                ...
                                <div class="col m12" id="colres">
                                    <table class="bordered" id="tbl">
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                            ...
                                            echo '<tr><td colspan="5"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?page=tsmd&act=disp&id_surat='.$row['id_surat'].'&sub=add">Tambah data baru</a></u></p></center></td></tr>';
                                        }
                                echo '</tbody></table>
                                </div>
                            </div>
