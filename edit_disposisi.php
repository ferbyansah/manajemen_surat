    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['tujuan'] == "" || $_REQUEST['isi_disposisi'] == "" || $_REQUEST['sifat'] == "" || $_REQUEST['batas_waktu'] == ""
                || $_REQUEST['catatan'] == "" || $_REQUEST['statusd'] == "" || $_REQUEST['pengirim'] == ""){
                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $catatan)){
                                ...
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $sifat)){
                                    ...
                                    $query = mysqli_query($config, "UPDATE tbl_disposisi SET tujuan='$tujuan', isi_disposisi='$isi_disposisi', sifat='$sifat', batas_waktu='$batas_waktu', catatan='$catatan', statusd='$statusd', pengirim='$pengirim', id_surat='$id_surat', id_user='$id_user' WHERE id_disposisi='$id_disposisi'");
                    ...
                    <form class="col s12" method="post" action="">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <input id="tujuan" type="text" class="validate" name="tujuan" value="<?php echo $row['tujuan'] ;?>"  readonly required>
                                    <?php
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="batas_waktu" type="text" name="batas_waktu" class="datepicker" value="<?php echo $row['batas_waktu']; ?>" readonly required>
                                    <?php
                            ...
                            <div class="input-field col s6">
                                ...
                                <textarea id="isi_disposisi" class="materialize-textarea validate" name="isi_disposisi" readonly required><?php echo $row['isi_disposisi'] ;?></textarea>
                                    <?php
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="catatan" type="text" class="validate" name="catatan" value="<?php echo $row['catatan'] ;?>" readonly required>
                                    <?php
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="sifat" type="text" class="validate" name="sifat" value="<?php echo $row['sifat'] ;?>" readonly required>
                                    <?php
                            ...
                            <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">low_priority</i><label>Pilih Pengirim</label><br/>
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="statusd" id="statusd" required>
                                    <option value="<?php echo $row['statusd']; ?>"><?php echo $row['statusd']; ?></option>
                                ...
                                <?php
                                    if(isset($_SESSION['statusd'])){
                                        $statusd = $_SESSION['statusd'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$statusd.'</div>';
                            ...
                            <div class="input-field col s6">
                                <i class="material-icons prefix md-prefix">featured_play_list   </i>
                                <input id="pengirim" type="text" class="validate" name="pengirim" value="<?php echo $row['pengirim'] ;?>" readonly required>
                                    <?php
                                        if(isset($_SESSION['pengirim'])){
                                            $pengirim = $_SESSION['pengirim'];
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$pengirim.'</div>';
                                            unset($_SESSION['pengirim']);
                                        }
                                    ?>
