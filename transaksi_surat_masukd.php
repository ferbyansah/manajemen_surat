            ...
            if(isset($_REQUEST['act'])){
                ...
                switch ($act) {
                    case 'add':
                        ...
                        break;
                    case 'edit':
                        include "edit_surat_masukd.php";
                        break;
                    case 'disp':
                        include "disposisid.php";
                        break;
                    case 'print':
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE asal_surat LIKE '%$cari%' OR keterangan LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  ...
                                  <tr>
                                    ...
                                    if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 5){
                                        echo '<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                            <i class="material-icons">print</i> PRINT</a>
                                            <a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih Disp untuk menambahkan Disposisi Surat" href="?page=tsmd&act=disp&id_surat='.$row['id_surat'].'">
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE keterangan = 'Dekan FT' ORDER by id_surat DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 5){
                                            echo '<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>
                                                <a class="btn small blue waves-effect waves-light" href="?page=tsmd&act=edit&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">edit</i> EDIT</a>
                                                <a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih Disp untuk menambahkan Disposisi Surat" href="?page=tsmd&act=disp&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">description</i> DISP</a>';

                                        } else {
                                          echo '<a class="btn small blue waves-effect waves-light" href="?page=tsmd&act=edit&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">edit</i> EDIT</a>
                                                <a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih Disp untuk menambahkan Disposisi Surat" href="?page=tsmd&act=disp&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">description</i> DISP</a>
                                                <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
